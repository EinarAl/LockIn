...
export default function CourseDetail() {
  ...
  const [tab, setTab] = useState<'events' | 'grades'>('events')
...
const tabStyle: React.CSSProperties = { padding: '8px 16px', borderWidth: 1, borderStyle: 'solid', borderColor: '#ddd', background: '#f5f5f5', borderRadius: 4, cursor: 'pointer' }
